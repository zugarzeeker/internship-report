...
### Day 9 - 13/06/2016
เริ่มต้นด้วยการลอง Build Project ที่ทำเว็บ Admin ด้วย AngularJS เอาไปทดสอบ บน Server ของบริษัท แล้วพบว่ามีปัญหามากมาย จากการใช้ grunt build เวลา uglify minify แค่พิมพ์ `/views/mydirective.html` จริงๆ ต้องพิมพ์​ `views/mydirective.html` แค่นี้ ก็ build ไม่ผ่านแล้ว 

ปัญหาที่พบอีกคือ ngCropper ที่ใช้ ตอน uglify แล้วมีปัญหาเหมือนกัน เลยพยายามหาทางแก้ ก็มีหลายวิธี ignore จากนั้น copy แล้วชี้ตริงๆ การแก้ก็ต้องคิดถึง Dependency ต่างๆ ว่า คนที่ pull git ไป จะใช้งานได้ปกติ เผื่อต้องแก้ในอนาคต เลยค่อนข้างใช้เวลา พี่ๆ ที่บริษัท ก็ให้คำแนะนำหลายๆแบบ ที่เคยเจอมา ช่วยๆหา จนสุดท้ายก็ build และ pull บน server ตอนนี้รันได้เรียบร้อยแล้ว : )

กลับมาแก้งาน Frontend ต่อ โดยผมได้แก้เพิ่มให้สามารถ Crop รูปแล้วส่งไปขั้นตอนต่อไปในการจัดการรูปได้ ซึ่งพี่ที่บริษัทได้เขียนให้แล้วคือ Dithering เอกดนัยแก้เกี่ยวกับ Menu และ Flow ของ Web ในการผ่านแต่ละขั้นตอน
