...
เอกดนัยได้ทำเกี่ยวกับส่วน Pixelation suggestion แนะนำรายการที่ส่งผลต่อ Effect ต่างๆของรูป, หน้า loading modal ระหว่างรอประมวลผล effect ของรูปภาพ นอกจากนี้ยังแก้ปัญหา Dithering stack exceed ด้วย
